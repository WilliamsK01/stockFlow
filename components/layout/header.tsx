    ...
    <header className="flex h-16 items-center justify-between border-b bg-background px-6">
      ...
      <div className="flex items-center gap-4 flex-1">
        <div className="relative max-w-md flex-1">
          ...
          <Input placeholder="Rechercher un article, référence..." className="pl-10" />
        </div>
      </div>
            ...
            <div className="space-y-2 p-2">
              <div className="flex items-start gap-3 p-2 rounded-lg bg-warning/10">
                ...
                <div className="flex-1 text-sm">
                  ...
                  <p className="text-muted-foreground">Article REF001 - Seuil critique atteint</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-2 rounded-lg bg-info/10">
                ...
                <div className="flex-1 text-sm">
                  ...
                  <p className="text-muted-foreground">Commande N°123456 - Livraison prévue le 15/07/2025</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-2 rounded-lg bg-primary/10">
                ...
                <div className="flex-1 text-sm">
                  ...
                  <p className="text-muted-foreground">Commande CMD-2025-001 à traiter</p>
                </div>
              </div>
            </div>
          </DropdownMenuContent>
